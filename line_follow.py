...
def follow_line():
    ...
    while True:
        ...
        if ref1 > ref2:
            ...
            print("is_1: ", steer_ls_l.reflected_light_intensity)
            print("is_1: ", steer_ls_l.ambient_light_intensity)
            print("is_2: ", steer_ls_r.reflected_light_intensity)
            print("is_2: ", steer_ls_r.ambient_light_intensity)
        elif ref1 < ref2:
